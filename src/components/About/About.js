          ...
          <Col md className="pe-3">
            <Bounce bottom>
              ...
              <p className="text-muted">
                ...
                service completion rate in the industry.
              </p>
              <p className="text-muted">
                And the reason is, we don’t give up. When a student commits to a
                service, we commit to the student. We are not going to sugar
                coat it - we will make you complete, come what may. You may not
                have given much thought to what you are signing up for, but we
          ...
          <Col md className="pe-3">
            <Bounce bottom>
              ...
              <p className="text-muted">
                ...
                continue and complete services by attending live online
                services, using a team of ridiculously committed educators who
                will stop at nothing to impart education, helped by a 24 x 7
                support system. By deploying our world class team of industry
                experts, we aim to educate our learners with the skills they
                need to advance their professional life to the next level.
              </p>
            </Bounce>
          </Col>
        </Row>
